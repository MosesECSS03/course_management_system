  ...
  {
    console.log("Logout");
    var response = await axios.post(`https://moses-course-testing-dqghhsbcgseccyfa.japaneast-01.azurewebsites.net/login`, { "purpose": "logout", "accountId": this.props.location.state?.accountId});
