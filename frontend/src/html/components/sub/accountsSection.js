...
class AccountsSection extends Component {
  ...
  async fetchAccounts() 
  {
    try {
      ...
      var response = await axios.post(`https://moses-course-testing-dqghhsbcgseccyfa.japaneast-01.azurewebsites.net/accountDetails`, { "purpose": "retrieve"});
  ...
  async fetchAccessRights() 
  {
    try {
      ...
      var response = await axios.post(`https://moses-course-testing-dqghhsbcgseccyfa.japaneast-01.azurewebsites.net/accessRights`, { "purpose": "retrieve"});
      console.log(response.data.result);
